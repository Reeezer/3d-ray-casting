function displayTitle(title, a, b, c, d, e, f, g) {
   ...
   /* var bro = new Array();
    ...
    var titleAsHeader = "<header><h1>&nbsp;" + title + "<br /></h1><br>&nbsp;&nbsp;<a href='http://webgl3d.info' style='text-decoration:none; color: white;'>WebGL par la pratique&copy; 2015-2020</a></header>";
